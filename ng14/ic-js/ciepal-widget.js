...
function main() {
    jQuery(document).ready(function($) {
      ...
      $.getJSON(jsonp_url, function(data) {
        ...
        //console.log("data");
        $('#career-widget-container').html(data.html).css({'min-height':550});
      });
      ...
      //     //Your code
      //     console.log(data);
      //     $('#career-widget-container').html(data.html);
      // }
      // });
...
{
  //console.log("TEST");
  //console.log((document.getElementById('career-widget-container').offsetTop - 50));
  //window.scrollTo({ top: (document.getElementById('career-widget-container').offsetTop + 250), behavior: 'smooth' });
  document.getElementById('career-widget-container').scrollIntoView({ behavior: 'smooth'});
}
